      ...
      <Container maxWidth="lg" className={classes.container}>
        <Grid container spacing={1}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={3} />
            <Grid item xs={3} >
            <FormControlLabel control={<Checkbox defaultNotChecked onChange={handleDisconnectedChange} />} label="Disconnected Sites" />
            </Grid>
            <Grid item xs={3} >
            <FormControlLabel control={<Checkbox defaultNotChecked onChange={handleDownChange} />} label="Down Agents" />
            </Grid>
            <Grid item xs={3}>
              <TextField
                id="outlined-basic"
