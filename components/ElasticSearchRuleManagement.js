...
const ElasticSearchRuleComponent = () => {
  ...
  const filterQueries = [
    { name: 'Aborted Transactions', query: 'labels.http_route: "/pos/order/{orderId}/{version}/void" and url.path : * and http.response.status_code: 200', jsonQuery: '{\"bool\":{\"filter\":[{\"bool\":{\"should\":[{\"term\":{\"labels.http_route\":{\"value\":\"/pos/order/{orderId}/{version}/void\"}}}],\"minimum_should_match\":1}},{\"bool\":{\"should\":[{\"exists\":{\"field\":\"url.path\"}}],\"minimum_should_match\":1}}]}}' },
    { name: 'Abort Transaction Failure', query: '(http.response.status_code >= 400 and http.response.status_code < 600)  and url.path: * and labels.http_route: "/pos/order/{orderId}/{version}/void"', jsonQuery: '{"bool":{"filter":[{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}},{"bool":{"should":[{"term":{"labels.http_route":{"value":"/pos/order/{orderId}/{version}/void"}}}],"minimum_should_match":1}}]}}' },
    ...
    { name: 'Failed To Process Transactions', query: 'labels.http_route :"/pos/order/{orderId}/{version}/complete" and url.path: *  and (http.response.status_code >= 400 and http.response.status_code < 600)', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/pos/order/{orderId}/{version}/complete"}}}],"minimum_should_match":1}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}}]}}' },

    { name: 'Suspended Transaction', query: 'labels.http_route: "/pos/order/{orderId}/{version}/suspend" and url.path : * and http.response.status_code: 200', jsonQuery: '{\"bool\":{\"filter\":[{\"bool\":{\"should\":[{\"term\":{\"labels.http_route\":{\"value\":\"/pos/order/{orderId}/{version}/suspend\"}}}],\"minimum_should_match\":1}},{\"bool\":{\"should\":[{\"exists\":{\"field\":\"url.path\"}}],\"minimum_should_match\":1}}]}}' },
    { name: 'Failed To Suspend Transactions', query: 'labels.http_route: "/pos/order/{orderId}/{version}/suspend" and url.path : * and (http.response.status_code >= 400 and http.response.status_code < 600)', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/pos/order/{orderId}/{version}/suspend"}}}],"minimum_should_match":1}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}},{"bool":{"should":[{"bool":{"should":[{"match":{"http.response.status_code":"400"}}],"minimum_should_match":1}},{"bool":{"should":[{"match":{"http.response.status_code":"401"}}],"minimum_should_match":1}}],"minimum_should_match":1}}]}}' },
    ...
    { name: 'Failed to Open Till', query: 'labels.http_route :"/cash-management/till/open" and (http.response.status_code >= 400 and http.response.status_code < 600) and url.path: *', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/cash-management/till/open"}}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}}]}}' },
    ...
    { name: 'Failed to PickUp Till', query: 'labels.http_route :"/cash-management/till/{tillId}/pickup" and (http.response.status_code >= 400 and http.response.status_code < 600) and url.path: *', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/cash-management/till/{tillId}/pickup"}}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}}]}}' },
    ...
    { name: 'Failed to Close Till', query: 'labels.http_route: "/cash-management/till/{id}/close" and url.path: * and (http.response.status_code >= 400 and http.response.status_code < 600)', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/cash-management/till/{id}/close"}}}],"minimum_should_match":1}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}}]}}' },
    ...
    { name: 'Failed to Suspend Tills', query: 'labels.http_route :"/cash-management/till/{id}/suspend" and (http.response.status_code >= 400 and http.response.status_code < 600) and url.path: *', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/cash-management/till/{id}/suspend"}}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}}]}}' },
    ...
    { name: 'Failed to Loan Till', query: 'labels.http_route :"/cash-management/till/{tillId}/loan" and (http.response.status_code >= 400 and http.response.status_code < 600) and url.path: *', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/cash-management/till/{tillId}/loan"}}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}}]}}' },

    { name: 'Authorization/Manager Override Successful', query: 'labels.http_route: "/authorization/login" and http.response.status_code: 200 and url.path: *', jsonQuery: '{\"bool\":{\"filter\":[{\"bool\":{\"should\":[{\"term\":{\"labels.http_route\":{\"value\":\"/authorization/login\"}}}],\"minimum_should_match\":1}},{\"bool\":{\"should\":[{\"exists\":{\"field\":\"http.response.status_code\"}}],\"minimum_should_match\":1}},{\"bool\":{\"should\":[{\"match\":{\"http.response.status_code\":\"200\"}}],\"minimum_should_match\":1}},{\"bool\":{\"should\":[{\"exists\":{\"field\":\"url.path\"}}],\"minimum_should_match\":1}}]}}' },
    { name: 'Authorization/Manager Override Failed', query: 'labels.http_route: "/authorization/login" and (http.response.status_code: 401) and url.path: *', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/authorization/login"}}}],"minimum_should_match":1}},{"bool":{"should":[{"match":{"http.response.status_code":"401"}}],"minimum_should_match":1}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}}]}}' },
    ...
    { name: 'Failed Operator Sign-In', query: 'labels.http_route :"/endpoint-status/{deviceId}/operator-sign-in" and  url.path: * and (http.response.status_code >= 400 and http.response.status_code < 600)', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/endpoint-status/{deviceId}/operator-sign-in"}}}],"minimum_should_match":1}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}}]}}' },
    ...
    { name: 'Failed Operator Sign-Out', query: 'labels.http_route :"/endpoint-status/{deviceId}/operator-sign-out" and (http.response.status_code >= 400 and http.response.status_code < 600) and url.path: *', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/endpoint-status/{deviceId}/operator-sign-out"}}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}}]}}' },
    ...
    { name: 'Failed To Coupon/Price Reduce Items', query: 'labels.http_route: "/pos/order/{orderId}/{version}/item/{orderItemId}/{orderItemPriceId}/price-modification/manual/add" and url.path: * and (http.response.status_code >= 400 and http.response.status_code < 600)', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/pos/order/{orderId}/{version}/item/{orderItemId}/{orderItemPriceId}/price-modification/manual/add"}}}],"minimum_should_match":1}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}}]}}' },
    ...
    { name: 'Failed To Order Coupon/Price Reduce', query: 'labels.http_route: "/pos/order/{orderId}/{version}/price-modification/manual/add" and url.path: * and (http.response.status_code >= 400 and http.response.status_code < 600)', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/pos/order/{orderId}/{version}/price-modification/manual/add"}}}],"minimum_should_match":1}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}}]}}' },
    ...
    { name: 'Failed to Add Items to Order', query: '(labels.http_route :"/pos/order/{orderId}/{version}/barcode/add" or labels.http_route: "/pos/order/barcode/add") and url.path: * and (http.response.status_code >= 400 and http.response.status_code < 600)', jsonQuery: '{"bool":{"filter":[{"bool":{"should":[{"bool":{"should":[{"term":{"labels.http_route":{"value":"/pos/order/{orderId}/{version}/barcode/add"}}}],"minimum_should_match":1}},{"bool":{"should":[{"term":{"labels.http_route":{"value":"/pos/order/barcode/add"}}}],"minimum_should_match":1}}],"minimum_should_match":1}},{"bool":{"should":[{"exists":{"field":"url.path"}}],"minimum_should_match":1}},{"bool":{"filter":[{"bool":{"should":[{"range":{"http.response.status_code":{"gte":"400"}}}],"minimum_should_match":1}},{"bool":{"should":[{"range":{"http.response.status_code":{"lt":"600"}}}],"minimum_should_match":1}}]}}]}}' },
